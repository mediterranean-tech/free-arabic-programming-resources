<div align="center">
	...
	<p>
		<p>
			<sup>
				<a href="https://github.com/sponsors/davidawad">Sponsor this project</a>
			</sup>
		</p>
...
<div align="center">
	For now, we've converted a list with a lot of resources we want to translate or find equivalent resources for. (feel free to contribute!)

    In the meanitime, take a look at this great list by 01walid.


في الوقت الحالي ، قمنا بتحويل قائمة بها الكثير من الموارد التي نريد ترجمتها أو إيجاد موارد مكافئة لها.

     في هذه الأثناء ، ألق نظرة على هذه القائمة الرائعة بواسطة 01walid.
